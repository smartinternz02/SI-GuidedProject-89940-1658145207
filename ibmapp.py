...
API_KEY = "4IgZR_euT_vdjcX1O5KzOw-wAxAdCFscO-AQ6NLTmGab"
...
app=Flask(__name__)
model = pickle.load(open(r"C:\Users\guruo\OneDrive\Desktop\smart\model3.pkl",'rb'))
...
def predict():
    ...
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/2882c4a6-20d4-427d-b841-068e70b5fe1f/predictions?version=2022-08-03', json=payload_scoring,
    headers={'Authorization': 'Bearer ' + mltoken})
